...
<Callout>
  Test cycles went from two days to seconds. Dramatically reduced release
  complexity.
</Callout>
...
<Callout>
  Supporting a new customer experience went from roughly two months of dev work
  to under a week. Meaningfully improved customer satisfaction scores.
</Callout>
