...
The site is built on [Next.js](https://nextjs.org) with [Fumadocs](https://fumadocs.vercel.app), an MDX-based documentation framework. All the content lives as MDX files in `content/docs/`, and Fumadocs handles the sidebar, search, and page rendering. Most days that means I'm just writing Markdown, and when I want something custom I can drop a React component straight into the page.
